...
# 贝塞尔曲线实战1
## 需求
用贝塞尔曲线画一个圆，在文章里面是用4个二阶贝塞尔曲线，画出一个圆
## 必备知识
在画圆之前，我需要告诉大家圆要怎么去计算控制点的位置，和计算圆的面积一样，让一个圆不断的解决完美的圆，也是需要一个常量
~~~java
private static final float C = 0.551915024494f;     // 一个常量，用来计算绘制圆形贝塞尔曲线控制点的位置
~~~

关于这个常量怎么计算出来的，可以去看看：https://stackoverflow.com/questions/1734745/how-to-create-circle-with-b%C3%A9zier-curves

## 效果
![image](http://ww2.sinaimg.cn/large/005Xtdi2jw1f3ch74ewiig308c0e8wic.gif)
...
## 总结
贝塞尔曲线画简单的曲线其实不难，毕竟贝塞尔曲线的公式你都不用学，二到三阶的方法就封装好了。。。